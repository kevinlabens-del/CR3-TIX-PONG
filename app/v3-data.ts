...
export const CAMPAIGN_STAGES: CampaignStage[] = [
  ...
  { id: 45, chapter: 10, name: "Citadelle du vide", subtitle: "Tiens bon sous la pression", aiSpeed: 1100, reaction: 14, ballSpeed: 1060, winScore: 9, playerHeight: 156, enemyHeight: 200, modifier: "pressure", reward: 186, aiBehavior: "predictive", objectives: [win("s45-win"), objective("s45-combo", "combo", 5, "Atteindre un combo ×5"), objective("s45-concede", "maxConceded", 2, "Encaisser au maximum 2 points")] },
