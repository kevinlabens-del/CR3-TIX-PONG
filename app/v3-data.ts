...
export const CAMPAIGN_STAGES: CampaignStage[] = [
  ...
  { id: 8, chapter: 2, name: "Maître de la Faille", subtitle: "VORTEX brise les trajectoires", aiSpeed: 850, reaction: 21, ballSpeed: 810, winScore: 6, playerHeight: 162, enemyHeight: 230, modifier: "boss", reward: 95, aiBehavior: "boss", boss: "VORTEX", objectives: [win("s8-win", "Vaincre VORTEX"), objective("s8-perfect", "perfect", 5, "Réaliser 5 Perfect Hits"), objective("s8-time", "time", 120, "Vaincre en moins de 120 s")] },
